...
public class TxtConcreteProduct extends Product {
	
	private BufferedWriter writer;
	private static final String DATEINAME = "BahnhoefeAusgabe.txt";

	public TxtConcreteProduct() throws IOException {
	...
	public void fuegelnDateiHinzu(Object object) throws IOException {
		if (object instanceof Bahnhof) {
			...
			// Hier erfolgt die spezifische Formatierung für den Bahnhof in TXT
